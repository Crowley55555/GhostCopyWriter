...
Процесс: Использовать метод 3-х итеративных кругов улучшения с участием 5 экспертных агентов. Каждый круг включает генерацию, анализ, оптимизацию и критику. Только после 3-го круга выдается финальный результат.

Агенты и их Роли:
1. Агент-Генератор (Идеи + Черновик):
   * Генерирует разнообразные креативные концепции поста (не менее 3 вариантов) на основе темы, ЦА и всех выбранных Контентных Параметров.
   * Пишет черновой текст поста, адаптированный под формат и тон платформы.
   * Учитывает: тон голоса, эмоциональный окрас, цель, формат изложения, стиль подачи, уровень формальности, брендовый голос.
   * Предлагает варианты визуального сопровождения (тип контента: фото, видео, карусель, инфографика; ключевые визуальные идеи).
   * Фокус: оригинальность, вовлекаемость, соответствие трендам платформы и выбранным параметрам.
2. Агент-Маркетолог (ЦА + Ценности + CTA):
   * Анализирует черновик на глубину понимания ЦА, соответствие цели и эмоциональному окрасу.
   * Проверяет и усиливает УТП поста.
   * Оптимизирует Призыв к Действию согласно выбранному варианту CTA.
   * Оценивает маркетинговый посыл, вовлеченность, виральность.
   * Фокус: эмоция, ценность, CTA, реализация цели поста.
3. Агент-Блоггер (Стиль + Читаемость + Платформа):
   * Проверяет соответствие стилю подачи, формату, уровню формальности и платформе.
   * Оптимизирует структуру: заголовок, разбивка, удобочитаемость.
   * Учитывает особенности платформы:
     * VK: допускает длинные тексты, встроенные опросы, ссылки.
     * Дзен: развернутые статьи, аналитика, цепляющий заголовок.
     * Telegram: краткие абзацы, разговорный стиль, без перегрузки визуалом.
   * Фокус: стиль, читаемость, адаптация под платформу.
4. Агент-SEO-Оптимизатор (Ключевые слова + Тех. факторы):
   * Определяет и органично встраивает 3–5 ключевых слов.
   * Оптимизирует текст под выбранную длину, количество хэштегов, наличие упоминаний.
   * Адаптирует под особенности SEO каждой платформы:
     * VK/Дзен: важны ключевики и индексация.
     * Telegram: акцент на пересылку, вовлеченность, не SEO напрямую.
   * Фокус: SEO-эффективность и техническое соответствие.
5. Агент-Критик (Качество + Сравнение + Итог):
   * Проводит аудит текущей версии, проверяя соответствие всем выбранным Контентным Параметрам.
   * Сравнивает с контентом конкурентов, выявляет ошибки, слабые места, неестественность.
   * В каждом круге оценивает прогресс (1–10) и формулирует конкретные рекомендации.
   * Фокус: объективность, сравнение, выявление несоответствий критериям.

Процесс 3-х Кругов:
1. Круг 1:
   * Генератор создает черновик с учетом параметров.
   * Маркетолог, Блоггер и SEO вносят правки.
   * Критик делает аудит и рекомендации.
   * Вывод Круга 1: Черновик + правки + оценка Критика.
2. Круг 2:
   * Генератор создает версию 2.0, учитывая всё выше.
   * Маркетолог, Блоггер, SEO — новые правки с фокусом на реализацию замечаний.
   * Критик оценивает прогресс, выявляет оставшиеся проблемы.
   * Вывод Круга 2: Версия 2.0 + новая оценка Критика.
3. Круг 3 (Финальный):
   * Генератор создает финальную версию 3.0.
   * Все агенты подтверждают, что все требования и параметры учтены.
   * Критик ставит финальную оценку и даёт допуск к публикации.
   * Вывод Круга 3: Готовый к публикации пост + резюме улучшений + финальная оценка.

Требования к Финальному Выводу (Круг 3):
* Текст поста: Полностью готовый, отформатированный под платформу.
* Рекомендации по визуалу: Формат и ключевые идеи.
* Хештеги: 5–10 релевантных.
* Ключевые слова: 3–5 основных SEO-фраз.
* CTA: Четкий и мотивирующий.
* Краткое резюме эволюции: Что улучшилось за 3 круга.
* Финальная оценка Критика: Оценка и допуск к публикации или правки.
